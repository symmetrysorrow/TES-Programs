# Optimized SinglePixel conformal Stycast32 mortar HYPRE partial versus COMSOL

- Comparison window: 0–38.750 µs after the 20.020 ms pulse
- Mesh: `mesh_singlepixel_prod_v2` (optimized production-v2)
- Solver: `conformal Stycast32 mortar HYPRE partial`
- Early timestep: 0.625 µs (optimized hybrid grid)
- COMSOL baseline: 143.055049 µA
- conformal Stycast32 mortar HYPRE partial baseline: 143.534426 µA (+0.335%)
...
- t10 (COMSOL / conformal Stycast32 mortar HYPRE partial): 41.7428 / n/a µs
- t50 (COMSOL / conformal Stycast32 mortar HYPRE partial): 92.8374 / n/a µs

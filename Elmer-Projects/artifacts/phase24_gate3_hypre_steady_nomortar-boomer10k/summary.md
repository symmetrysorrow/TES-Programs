...
- Status: **FAIL**
- Case: `case_phase24_gate3_hypre_steady_prod_v2_nomortar-boomer10k`
- Mesh: `mesh_singlepixel_prod_v2`; mortar: `False`
- Initial state: `T_0`, with no restart input
- HYPRE: `iterative_hypre_flexgmres_boomeramg`, max 10000 iterations, tolerance `1e-10`
...
- HYPRE final linear residual: `3.2562913887653445e-07`
- Elmer nonlinear residual: `None`
- TES circuit residual [W]: `0.0`

Project: `D:\Github\TES-Programs\Elmer-Projects\artifacts\phase24_gate3_hypre_steady_nomortar-boomer10k\phase24_gate3_hypre_steady.json`
Solver log: `D:\Github\TES-Programs\Elmer-Projects\results\case_phase24_gate3_hypre_steady_prod_v2_nomortar-boomer10k\solver.log`
Launcher log: `D:\Github\TES-Programs\Elmer-Projects\results\case_phase24_gate3_hypre_steady_prod_v2_nomortar-boomer10k\gate3_launcher.log`
